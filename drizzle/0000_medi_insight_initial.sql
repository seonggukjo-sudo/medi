...
CREATE TABLE IF NOT EXISTS hospital_settings (
  hospital_id TEXT PRIMARY KEY NOT NULL,
  operation_profile TEXT NOT NULL DEFAULT 'weekly_meeting',
...
CREATE TABLE IF NOT EXISTS leads (
  ...
  status TEXT NOT NULL,
  batch_id TEXT NOT NULL,
  PRIMARY KEY (hospital_id, lead_id)
);
...
CREATE TABLE IF NOT EXISTS appointments (
  ...
  status TEXT NOT NULL,
  batch_id TEXT NOT NULL,
  PRIMARY KEY (hospital_id, appointment_id)
);
...
CREATE TABLE IF NOT EXISTS visits (
  ...
  batch_id TEXT NOT NULL,
  PRIMARY KEY (hospital_id, visit_id)
);
...
CREATE TABLE IF NOT EXISTS payments (
  ...
  batch_id TEXT NOT NULL,
  PRIMARY KEY (hospital_id, payment_id)
);
...
CREATE TABLE IF NOT EXISTS ad_spend (
  ...
  batch_id TEXT NOT NULL,
  PRIMARY KEY (hospital_id, spend_id)
);
